...
- **MPs' declared interests, votes, attendance**: parlamento.pt (Registo de Interesses under each deputy's page; open data for bulk).
...
- **Party and campaign money**: ECFP accounts and decisions; CNE for candidacies.
