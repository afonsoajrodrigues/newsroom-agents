...
7. **Deliver**: `index.html`, `data/`, `README.md` (source URL, extraction date, prep steps, builder, evidence IDs), and a one-paragraph note on any method choice (inflation, exclusions, "Other").
