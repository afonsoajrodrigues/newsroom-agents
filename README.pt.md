...
| `financial-corporate` | `corporate-structure-mapper`, `offshore-leaks-researcher` | `company-sources`: quem é dono e quem gere uma empresa, pela ordem que funciona (NIF primeiro, Publicações MJ, RCBE), mais GLEIF, Companies House, ICIJ, OpenSanctions |
